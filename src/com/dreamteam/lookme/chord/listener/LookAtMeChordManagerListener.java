...
public class LookAtMeChordManagerListener implements IChordManagerListener {
	...
	public LookAtMeChordManagerListener(ChordManager chordManager,
			IChordChannelListener publicChannelListener) {
	...
	public void onStarted(String arg0, int arg1) {
		...
		IChordChannel publicChannel = chordManager.joinChannel(
				ChordManager.PUBLIC_CHANNEL, publicChannelListener);
