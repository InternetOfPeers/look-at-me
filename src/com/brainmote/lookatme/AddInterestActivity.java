...
public class AddInterestActivity extends CommonActivity {
	...
	//
	// public InterestAdapter(Context context, int textViewResourceId, int
	// interestID, Set<Interest> interestList) {
	//
	// super(context, textViewResourceId, interestID, new
	...
	// System.out.println(position +
	// " ########################### COINCIDONOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO ########################### ");
